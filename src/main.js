...
setTimeout(async () => {
  ...
  try {
    ...
    const bgPrimary = getComputedStyle(root).getPropertyValue('--freddy-bg-primary')
    const textPrimary = getComputedStyle(root).getPropertyValue('--freddy-text-primary')
    const borderColor = getComputedStyle(root).getPropertyValue('--freddy-border-color')
    const primaryColor = getComputedStyle(root).getPropertyValue('--freddy-primary-color')
  ...
  if (chatElement) {
    ...
    console.log('Element is defined:', customElements.get('freddy-chat-interface') !== undefined)
  } else {
